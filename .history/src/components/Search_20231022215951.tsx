  ...
  return (
    <div className='relative' ref={searchRef}>
      <input
        ...
        placeholder='Search...'
        className={`w-[400px] absolute top-0 right-0 z-30 focus:border-info border-2 border-slate-500 rounded-xl bg-slate-600 outline-none px-12 py-2 text-xl bg-no-repeat bg-[length:25px] bg-[center_left_14px] bg-[url("${searchIcon}")] placeholder:text-lg`}
      />
      {value && !isFetching && (
        <img
