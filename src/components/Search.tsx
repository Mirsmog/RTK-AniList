  ...
  return (
    <div className='relative' ref={searchRef}>
      <input
        ...
        placeholder='Search...'
        className={`w-[400px] focus:border-info border-2 z-30 relative rounded-xl bg-slate-600 outline-none px-12 py-2 text-xl bg-no-repeat bg-[length:25px] bg-[center_left_14px] bg-[url("${clearIcon}")] placeholder:text-lg border-slate-500`}
      />
      {value && !isFetching && (
        <img
